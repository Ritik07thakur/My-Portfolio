      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <div className="mb-6">
              <h3 className="text-xl md:text-2xl font-semibold text-primary mb-2 flex items-center justify-center md:justify-start">
        ...
        <p className="text-base md:text-lg text-muted-foreground mt-8 max-w-3xl text-center">
